...
temperature_model <- lm(
  mean_temp_c ~ elevation_m, # formula: change in mean temp as a function of elevation 
  data = sonadora_sum # data frame : sum of Sonadora data 
  )
...
plot(temperature_model) # display diagnostic plots for model 
...
summary(temperature_model) # more information about the model 
